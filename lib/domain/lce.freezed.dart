...
abstract class $LceCopyWith<T, $Res> {
  factory $LceCopyWith(Lce<T> value, $Res Function(Lce<T>) then) =
      _$LceCopyWithImpl<T, $Res, Lce<T>>;
}

/// @nodoc
class _$LceCopyWithImpl<T, $Res, $Val extends Lce<T>>
    implements $LceCopyWith<T, $Res> {
...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$LceCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class __$$ContentImplCopyWithImpl<T, $Res>
    extends _$LceCopyWithImpl<T, $Res, _$ContentImpl<T>>
...
class _$ContentImpl<T> with DiagnosticableTreeMixin implements Content<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$LceCopyWithImpl<T, $Res, _$ErrorImpl<T>>
