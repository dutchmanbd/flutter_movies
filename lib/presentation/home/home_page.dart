              ...
              child: Row(
                ...
                children: [
                  ...
                  roundButton(Icons.search, () {
                    _vm(ref).searchMovie(searchController.text);
                  }),
                ],
              ),
            ),
...
class HistoryListWidget extends HookConsumerWidget {
  @override
  Widget build(BuildContext context, WidgetRef ref) {
...
class _MovieListWidget extends HookConsumerWidget {
...
class _ProgressIndicator extends HookConsumerWidget {
  @override
  Widget build(BuildContext context, WidgetRef ref) {
